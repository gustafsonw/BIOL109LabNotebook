...
| Stratum basale (germinitivum) | deepest layer of the epidermis, made of epidermal stem cells |
...
| Term | Definition |
|------------------------------------|------------------------------------|
| Subcutaneous Layer (Hypodermis) | connective tissue connecting the integument to the underlying bone and muscle |

**Integumentary Structures**

| Term | Definition |
|------------------------------------|------------------------------------|
| Dermal papillae | extension of the papillary layer of the dermis that increases surface contact between the epidermis and dermis |
...
| Arrector pili muscle | smooth muscle that is activated in response to external stimuli that pull on hair follicles and make the hair “stand-up” |
...
| Merocrine (eccrine) sweat gland | sweat gland that is common throughout the skin surface; it produces a hypotonic sweat for thermoregulation |
| Apocrine sweat gland | sweat gland that is in armpits and genital regions |
...
| Meissner's (tactile) corpuscle | receptor in the skin that responds to light touch |
| Pacinian (pressure) corpuscle | receptor in the skin that responds to vibration |
...
- 4: [epidermis]{.underline}
- 5: [dermis]{.underline}
- 6: [hypodermis]{.underline}

### Label the following accessory structures:

- 15: [sebaceous gland]{.underline}
- 21: [pacinian corpuscle]{.underline}
- 14: [arrector pili muscle]{.underline}
- 20: [merocrine sweat gland]{.underline}
...
- Compare the thick and thin skin models, or pictures, of the skin.
  - What differences do you note in their appearance and structure?
    ...
    Thick skin is hairless. Thin skin is hairy. Thick skin has thicker epidermis.

  - Where is each type located on the body? From this observation provide an explanation of each skin type's function.

    Thick skin is on palms, soles of feet, digits. Thin skin is on rest of body. Thick skin helps with more protection. Thin skin helps more with thermoregulation.

  - Identify and describe the layers of each type of skin.

    Thick skin has stratum basale, stratum spinosum, stratum granulosum, stratum lucidum, stratum corneum. Thin skin has those [except]{.underline} stratum lucidum
...
- Using one of the lab models, with the assistance of the picture below, locate the two layers of the dermis.
  - Locate the papillary ridge.
    ...
    The papillary ridge is located at the papillary dermis on fingertips, palms, toes, and soles of the feet.

  - Identify the type of connective tissue in each layer.

    Epidermis: no connective tissue

    Papillary Dermis: areolar tissue
...
- Dermal papillae
  ...
  supply nutrients and oxygen to the epidermis, anchor the dermis to the epidermis, uses increased surface area to do these

- Hair shaft

  provides protection against UV radiation, insulates body temp, enhances sensory perception

- Hair root

  producing, anchoring, nourishing hair shaft

- Hair follicle

  generate hair, determine hair texture and color, play crucial role in would healing and sensory perception

- Pore

  allow natural oils to lubricate skin, release sweat to regulate body temp

- Arrector pili muscle

  cause hair to stand on end which aids thermoregulation, sebum secretion, and protection

- Sebaceous gland

  produce/secrete sebum to lubricate and waterproof skin and hair

- Merocrine (eccrine) sweat gland.

  regulate body temp through evaporative cooling, produce/secrete sweat

- Apocrine sweat gland

  respond to emotional stress rather than temp regulation

- Free nerve ending

  primary detectors for pain, temp, and light/crude touch
...
- Keratinocyte
  ...
  body's first line of defense by creating a physical, waterproof barrier

- Melanocyte

  protect cells from UV radiation and provide color by producing melanin
...
|------------------------------------|------------------------------------|
| Dermal papillae | supply nutrients and oxygen to the epidermis, anchor the dermis to the epidermis, uses increased surface area to do these |
| Pore | allow natural oils to lubricate skin, release sweat to regulate body temp |
| Arrector pili muscle | cause hair to stand on end which aids thermoregulation, sebum secretion, and protection |
| Sebaceous gland | produce/secrete sebum to lubricate and waterproof skin and hair |
| Merocrine (eccrine) sweat gland | regulate body temp through evaporative cooling, produce/secrete sweat |
| Apocrine sweat gland | respond to emotional stress rather than temp regulation |
| Free nerve ending | primary detectors for pain, temp, and light/crude touch |
| Meissner's (tactile) corpuscle | responds to light touch |
| Pacinian (pressure) corpuscle | responds to vibration |
| Keratinocyte | body’s first line of defense by creating a physical, waterproof barrier |
| Melanocyte | protect cells from UV radiation and provide color by producing melanin |
...
Sebaceous Gland: produce/secrete sebum to lubricate and waterproof skin and hair\
Merocrine Sweat Gland: regulate body temp through evaporative cooling, produce/secrete sweat\
Apocrine Sweat Gland: respond to emotional stress rather than temp regulation\
...
| \# | Terms | Definitions |
|------------------|------------------|------------------------------------|
| 1 E | Pore | a\. The part of a hair projecting beyond the surface of the skin |
| 2 H | Arrector pili muscle | b\. An onion-shaped structure that is responsible for sensitivity to vibration and pressure |
| 3 G | Meissner's corpuscle | c\. Any of the small sacculated glands lodged in the substance of the derma, usually opening into the hair follicles, and secreting an oily material |
| 4 B | Pacinian corpuscle | d\. An organ found in mammalian skin which regulates hair growth |
| 5 K | Keratinocyte | e\. A small opening or empty space. |
| 6 I | Apocrine sweat gland | f\. The enlarged basal part of a hair within the skin |
| 7 D | Hair follicle | g\. A type of nerve ending in the skin that is responsible for sensitivity to pressure |
| 8 M | Dermal papillae | h\. The small smooth muscles associated with the base of each hair that contract when the body surface is chilled and erect the hairs |
| 9 L | Merocrine sweat gland | i\. Glands found in places like the armpits, scrotum, and anus. They tend to open into hair follicles instead of hairless areas of skin. |
| 10 F | Hair root | j\. An unspecialized, afferent nerve fiber ending of a sensory neuron |
| 11 C | Sebaceous gland | k\. An epidermal cell that produces keratin. |
| 12 J | Free nerve ending | l\. True sweat glands in the sense of helping to regulate body temperature |
| 13 A | Hair shaft | m\. Any vascular protuberance of the skin's dermal layer extending into the epidermal layer, often containing tactile corpuscles |
...
|------------------|------------------------------------|------------------|
| a\. | The epidermis is composed of [squamous epithelial tissue]{.underline}. | Hair bulb |
| b\. | The deepest layer of the epidermis. [stratum basale]{.underline} | Sudoriferous |
| c\. | The majority of the cells of the epidermis are [keratinocytes]{.underline}, so-called because they make [keratin]{.underline}. | stratum basale |
| d\. | Melanocytes are located in the [stratum basale]{.underline} (which layer?). | stratum lucidum |
| e\. | Immune cells in the stratum spinosum which protect against invaders are the [Langerhans' cells]{.underline}. | root |
| f\. | A very thin layer called the [stratum lucidum]{.underline} is in the epidermis but is visible only in thick skin. | keratin |
| g\. | The first level of protection against abrasion and toxic chemicals at the body's surface is provided by the [Stratum corneum]{.underline}. | Hair shaft |
| h\. | The dermis consists of two layers: the [papillary layer]{.underline}, which is characterized by a dimpled interface with the epidermis, and the [reticular layer]{.underline}, which accounts for 80% of the skin's thickness | Pacinian corpuscles; |
| i\. | The reticular layer of the dermis contains [Pacinian corpuscles]{.underline} to sense firm pressure. | papillary layer; reticular layer |
| j\. | Apocrine and eccrine glands are both [Sudoriferous]{.underline} (sweat) glands. | keratinocytes; keratin |
| k\. | [Ceruminous]{.underline} glands produce a waxy substance to protect the ear canal from dust, small insects, etc. | squamous epithelial tissue |
| l\. | The portion of the hair that is above the surface of the skin is called the [Hair shaft]{.underline}. | Stratum corneum |
| m\. | The sub-surface portion of the hair is called the [root]{.underline}. | Sudoriferous |
| n\. | The origin of the hair shaft, deep within the dermis, is called the [Hair bulb]{.underline}. | Ceruminous |
| o\. | The sheath in which a hair is held is called [follicle]{.underline}. | Langerhans' cells |
|  |  | follicle |
...
The child was ingesting a lot of carotene which caused the skin condition and it is not a condition he was worried about.\
\
\
...
Sweat glands produce and secrete sweat that helps regulate temp because of a cooling effect from evaporation.\
\
\

- How would you explain why a light skinned individual would be more susceptible to malignant melanoma?

Light skinned folks have less melanin to protect them from UV radiation which causes the malignant melanoma.\
\
\
...
|   | List three major types of glands associated with the integumentary system and describe their function. |
|--------------------|----------------------------------------------------|
| a\) Sebaceous Glands | produce/secrete sebum to lubricate and waterproof skin and hair |
| b\) Merocrine Sweat Glands | regulate body temp through evaporative cooling, produce/secrete sweat |
| c\) Apocrine Sweat Glands | respond to emotional stress rather than temp regulation |

|     | What are the three protective functions of the integumentary system? |
|--------------------|----------------------------------------------------|
| a\) | Physical barrier                                                     |
| b\) | UV radiation protection                                              |
| c\) | waterproofing barrier                                                |
...
|--------------------|----------------------------------------------------|
| a\) | stratum corneum |
| b\) | stratum lucidum - Not in thin skin |
...
|--------------------|----------------------------------------------------|
| a\) Hair Follicle | generate hair, determine hair texture and color, play crucial role in would healing and sensory perception |
| b\) Sebaceous Gland | produce/secrete sebum to lubricate and waterproof skin and hair |
| c\) Merocrine Sweat Gland | regulate body temp through evaporative cooling, produce/secrete sweat |
| d\) Apocrine Sweat Gland | respond to emotional stress rather than temp regulation |
