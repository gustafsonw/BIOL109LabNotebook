...
-   Epithelial [type of tissue that serves primarily as a covering or lining of body parts, protecting the body; it also functions in absorption, transport, and secretion]{.underline}
-   Connective [type of tissue that serves to hold in place, connect, and integrate the body’s organs and systems]{.underline}
-   Muscular [type of tissue that is capable of contracting and generating tension in response to stimulation; produces movement.]{.underline}
-   Nervous [tissue that is capable of sending and receiving impulses through electrochemical signals.]{.underline}

**Epithelial Tissues:**

-   Simple squamous [tissue that consists of a single layer of flat scale-like cells; promotes diffusion and filtration across surface]{.underline}
-   Stratified squamous (keratinized/nonkeratinized) [epithelium tissue that consists of multiple layers of cells with the most apical being flat scale-like cells; protects surfaces from abrasion]{.underline}
-   Simple cuboidal [tissue that consists of a single layer of cube-shaped cells; promotes secretion and absorption in ducts and tubules]{.underline}
-   Stratified cuboidal/columnar – [rare epithelium tissue that consists of two or more layers of cube-shaped cells, found in some ducts/stratified columnar epithelium tissue that consists of two or more layers of column-like cells, contains glands, and is found in some ducts]{.underline}
-   Simple columnar [tissue that consists of a single layer of column-like cells; promotes secretion and absorption in tissues and organs]{.underline}
-   Pseudostratified columnar epithelium [epithelium tissue that consists of a single layer of irregularly shaped and sized cells that give the appearance of multiple layers; found in ducts of certain glands and the upper respiratory tract]{.underline}
-   Transitional epithelium [stratified epithelium found in the urinary tract, characterized by an apical layer of cells that change shape in response to the presence of urine]{.underline}

**Define the following epithelial features:**

-   Epithelial layers:
    -   Simple [single layer of cells covering the basement membrane]{.underline}
    -   Stratified [several layers of cells above the basement membrane]{.underline}
-   Surfaces:
    -   Apical [part of a cell or tissue which, in general, faces an open space]{.underline}
    -   Basal [attached to other tissues]{.underline}
    -   Basement membrane [a thin layer of fibrous material that anchors the epithelial tissue to the underlying connective tissue; made up of the basal lamina and reticular lamina]{.underline}

**Connective Tissue:**

-   Cartilage [a connective tissue with a gelatinous matrix containing an abundance of fibers]{.underline}
-   Areolar connective tissue [a type of connective tissue proper that shows little specialization with cells dispersed in the matrix]{.underline}
-   Hyaline cartilage [most common type of cartilage, smooth and made of short collagen fibers embedded in a chondroitin sulfate ground substance]{.underline}
-   Adipose tissue [specialized areolar tissue rich in stored fat]{.underline}
-   Fibrocartilage [tough form of cartilage, made of thick bundles of collagen fibers embedded in chondroitin sulfate ground substance]{.underline}
-   Elastic cartilage [type of cartilage, with elastin as the major protein, characterized by rigid support as well as elasticity]{.underline}
-   Regular dense connective tissue [a connective tissue characterized by tightly packed collagen fibers arranged in parallel, providing strength and resistance to pulling forces in one direction.]{.underline}
-   Irregular dense connective tissue [a connective tissue characterized by collagen fibers that are arranged in a random, interwoven pattern, providing strength and resistance to stretching in multiple directions.]{.underline}
-   Bone [one of the hard parts of the skeleton of a vertebrate]{.underline}
-   Blood – detail in cardiovascular system [the fluid that circulates in the cardiovascular system]{.underline}

**Connective Tissue Features:**

-   Collagen fibers [flexible fibrous proteins that give connective tissue tensile strength]{.underline}
-   Elastin fibers [fibrous protein within connective tissue that contains a high percentage of the protein elastin that allows the fibers to stretch and return to original size]{.underline}
-   Extracellular matrix [a suspension of macromolecules that supports everything from local tissue growth to the maintenance of an entire organ.]{.underline}
-   Cells [The smallest living unit in the human body]{.underline}
    -   Fibroblasts [most abundant cell type in connective tissue, secretes protein fibers and matrix into the extracellular space]{.underline}
    -   Adipocytes [lipid storage cells]{.underline}
    -   Chondrocytes [cells of the cartilage]{.underline}
-   Lacuna [small spaces in bone or cartilage tissue that cells occupy]{.underline}
...
|--------------------------------------|------------|------------|------------|
| ![Figure 4.3](images/ch4_0.jpg)**Figure 4.3** | simple squamous epithelium | lining of peritoneal cavity | reduces friction, controls vessel permeability, performs absorption and secretion |
| ![Figure 4.4](images/ch4_1.jpg)**Figure 4.4** | simple cuboidal epithelium | kidney tubule | limited protection, secretion, absorption |
| ![Figure 4.5](images/ch4_2.jpg)**Figure 4.5** | simple columnar epithelium | intestinal lining | protection, secretion, absorption |
| ![Figure 4.6](images/ch4_3.jpg)**Figure 4.6** | stratified squamous epithelium | surface of tongue | provides physical protection against abrasion, pathogens, and chemical attack |
| ![Figure 4.7](images/ch4_4.jpg)**Figure 4.7** | pseudostratified ciliated columnar epithelium | trachea | protection, secretion, moves mucus with cilia |
| ![Figure 4.8](images/ch4_5.jpg)**Figure 4.8** | transitional epithelium | urinary bladder | permits expansion and recoil after stretching |

### **Terms:**

## **Epithelial Tissues:**

-   Simple squamous - tissue that consists of a single layer of flat scale-like cells; promotes diffusion and filtration across surface

-   Simple cuboidal - tissue that consists of a single layer of cube-shaped cells; promotes secretion and absorption in ducts and tubules

-   Simple columnar - tissue that consists of a single layer of column-like cells; promotes secretion and absorption in tissues and organs

-   Transitional - stratified epithelium found in the urinary tract, characterized by an apical layer of cells that change shape in response to the presence of urine
...
-   Loose Connective Tissue (Areolar connective tissue)
    -   Areolar - a type of connective tissue proper that shows little specialization with cells dispersed in the matrix
    -   Adipose Tissue - specialized areolar tissue rich in stored fat
-   Dense (fibrous) connective tissue - connective tissue proper that contains many fibers that provide both elasticity and protection
    -   Regular - a connective tissue characterized by tightly packed collagen fibers arranged in parallel, providing strength and resistance to pulling forces in one direction.
    -   irregular - a connective tissue characterized by collagen fibers that are arranged in a random, interwoven pattern, providing strength and resistance to stretching in multiple directions.
-   Fluid Connective Tissues - specialized cells that circulate in a watery fluid containing salts, nutrients, and dissolved proteins
...
-   Supportive connective tissue - type of connective tissue that provides strength to the body and protects soft tissue
    -   Cartilage - a connective tissue with a gelatinous matrix containing an abundance of fibers
        -   Hyaline - most common type of cartilage, smooth and made of short collagen fibers embedded in a chondroitin sulfate ground substance
        ...
        -   Elastic - type of cartilage, with elastin as the major protein, characterized by rigid support as well as elasticity
    -   Bone - one of the hard parts of the skeleton of a vertebrate

## **Features Bone:** Dense Connective Tissues

-   Osteoprogenitor cells - immature, self-renewing stem cells derived from mesenchymal stem cells that differentiate into osteoblasts for bone growth remodeling and repair
-   Osteocytes - a bone cell responsible for the maintenance and turnover of the mineral content of the surrounding bone
-   osteoclasts - cells that dissolve the fibers and matrix of bone
...
-   Lacuna - small spaces in bone or cartilage tissue that cells occupy
-   Canaliculi - microscopic passageways between cells; in bone, canaliculi permit the diffusion of nutrient and wastes to and from osteocytes
-   osteon canal - central channels in compact bone that house blood vessels, nerves, and lymphatic vessels
...
-   Discuss the two ways how epithelium can be classified.
    -   Use examples of how the structure and shape of the epithelium influences the function it serves in the area of the body in which it is located.
        ...
        Epithelium can be classified by cell shape and number of layers. Stratified squamous epithelium's multiple layers and cheap resource cost of being flat serve a function of expendable protection on skin from things like abrasion. Simple squamous epithelium's singular thin layer helps ease absorption like in kidney tubules.
-   With Respect to the tissues
    ...
    -   Describe their general characteristics and give an example of where they can be found.
        ...
        Epithelial: covers exposed surfaces, lines internal passageways and chambers, produces glandular secretions: Skin

        Connective: fills internal spaces, provides structural support, stores energy: Bone

        Muscle: contracts to produce active movement: Skeletal muscles

        Nervous: propagates electrical impulses, carries information: Brain
-   The [epithelial]{.underline} tissue contains an apical surface.
...
1.  **Fig. 4.10** Bone: Bones

![](images/_page_89_Picture_7.jpeg)

2.  **Fig. 4.11** Fibrous Cartilage: Pads within knee joint

![](images/_page_89_Picture_11.jpeg)

3.  **Fig. 4.12** Elastic cartilage: Epiglottis

![](images/_page_89_Picture_5.jpeg)

4.  **Fig. 4.13** Areolar: Between muscles

![](images/_page_89_Picture_9.jpeg)

5.  **Fig. 4.10** Dense regular connective: Tendons

![](images/_page_89_Picture_13.jpeg)

6.  **Fig. 4.15** Adipose: Deep to the skin
...
-   9 Protects underlying tissues from abrasion (10,8,10) **stratified squamous epithelium**
-   11 Function: secretion and absorption (6,8,10) **simple cuboidal epithelium**
